...
const CONFIG = {
  API_URL: 'https://script.google.com/macros/s/AKfycbzoB-W2lqiUH8LzFZSbwG87W4iECV30NK8sH9tR_x8NU6tfa9fUUc6cXXU4wTeFS_Di/exec',
  APP_NAME: 'HR MAWARAN',
...
const API = {
  ...
  async checkOut(employeeId)            { return this.request('checkOut', { employeeId }); },
...
function requireAuth(adminOnly = false) {
  ...
  if (adminOnly && user.role !== 'admin') { window.location.href = 'profile.html'; return null; }
  return user;
}
